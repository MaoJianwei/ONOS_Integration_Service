...
APP_JAR_MAP = {
    ...
    #    "//apps/ONOS_Integration_Service/api:onos-apps-mao-api": [],
    #    "//apps/ONOS_Integration_Service/cli:onos-apps-mao-cli": [],
    #    "//apps/ONOS_Integration_Service/core:onos-apps-mao-core": [],
    #    "//apps/ONOS_Integration_Service/web:onos-apps-mao-web": [],
}
...
APP_MAP = {
    ...
    #    "//web/gui:onos-web-gssui-oar": ["sona", "tost"],
    "//web/gui2:onos-web-gui2-oar": ["stratum", "tost"],
    "//apps/ONOS_Integration_Service:onos-apps-ONOS_Integration_Service-oar": [],
}
