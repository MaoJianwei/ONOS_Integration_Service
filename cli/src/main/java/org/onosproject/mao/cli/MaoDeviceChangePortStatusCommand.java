 ...
 */
package org.onosproject.mao.cli;
 ...
 */
@Service
@Command(scope = "onos", name = "mao-change-port-status",
        description = "Mao Device Test")
public class MaoDeviceChangePortStatusCommand extends AbstractShellCommand {
...
//    String mac = null;
    ...
    protected void doExecute() {
        ...
        maoDeviceService.changePortStatus();
